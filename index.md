...
<button class="button" id="download-zip" onclick="getLatestRelease(`https://api.github.com/repos/AndreaGrandieri/MagicMirror-GBM/releases/latest`)">Click me</button>
