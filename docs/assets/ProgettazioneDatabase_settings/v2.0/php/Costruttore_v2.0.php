...
// Creazione tabella "modules"
$exec_result = $db->exec("    CREATE TABLE modules (
...
if ($exec_result) {
    echo "Tabella \"modules\" creata correttamente";
} else {
    echo "Errore durante la creazione della tabella \"modules\"";
}

echo "<br>";

// Creazione tabella "globals"
$exec_result = $db->exec("    CREATE TABLE globals (
...
if ($exec_result) {
    echo "Tabella \"globals\" creata correttamente";
} else {
    echo "Errore durante la creazione della tabella \"globals\"";
}

echo "<br>";

// Inserimento record default per la tabella "modules"
// Conteggio records: 14
$exec_result = $db->exec("    INSERT INTO modules (NomeModulo, Active, RenderIndex, JsonFragment, JsonStableFragment)
    VALUES
        ('MMM-AirQuality', 1, 0,
        '{
...
if ($exec_result) {
    echo "Tabella \"modules\" popolata correttamente";
} else {
    echo "Errore durante la popolazione della tabella \"modules\"";
}        

echo "<br>";

// Inserimento record default per la tabella "globals"
// Conteggio record: 12
$exec_result = $db->exec("INSERT INTO globals (NomeGlobale, JsonFragment, JsonStableFragment)
    VALUES
        ('address',
        '\"localhost\"',
        '\"localhost\"'),
...
if ($exec_result) {
    echo "Tabella \"globals\" popolata correttamente";
} else {
    echo "Errore durante la popolazione della tabella \"globals\"";
}        
