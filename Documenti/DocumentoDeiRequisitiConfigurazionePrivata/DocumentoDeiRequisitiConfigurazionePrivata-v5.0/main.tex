\documentclass[a4paper,11pt,titlepage]{article}       % Articolo, Foglio A4, Carattere 11
...
\newglossaryentry{Sensore di movimento P.I.R.}
{
    name = Sensore di movimento P.I.R.,
    description = {acronimo di \emph{Passive InfraRed} è un sensore elettronico che rileva la radiazione infrarossa (IR) irradiata dagli oggetti nel suo campo visivo}
}

\begin{document}
\author{Documento dei requisiti \\ ver. 5.0}                             % Autore/i
\title{MagicMirror-GBM \\ configurazione ad uso privato}                    % Titolo
\date{17 Aprile 2021}                                % Data: mese/anno
\maketitle
