...
| MMM-DHT-Sensor <p style="background-color:green;">NO API KEY</p>                    | Mostra temperatura e umidità locali (usa sensore: `DHT11` o `DHT11` o `AM2302`)              | [MMM-DHT-Sensor](https://github.com/ryck/MMM-DHT-Sensor)                          |
